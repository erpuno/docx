...
namespace TemplateEngine.Docx
{
	...
	public class RepeatContent : HiddenContent<RepeatContent>, IEquatable<RepeatContent>
	{
		...
		public RepeatContent(string name, Content[] items)
            : this(name)
        {
			Items = items.ToList();
        }
		...
		public static RepeatContent Create(string name, Content[] items)
        {
		...
		public RepeatContent AddItem(IContentItem[] contentItems)
		{
			if (Items == null) Items = new Collection<Content>();
