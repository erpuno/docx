...
namespace TemplateEngine.Docx
{
	...
	public class ListContent : HiddenContent<ListContent>, IEquatable<ListContent>
	{
		...
		public ListContent(string name, ListItemContent[] items)
            : this(name)
        {
			Items = items.ToList();
        }
		...
		public static ListContent Create(string name, ListItemContent[] items)
        {
		...
		public ListContent AddItem(IContentItem[] contentItems)
		{
			if (Items == null) Items = new Collection<ListItemContent>();
